...
* TACACS+ clients configuration in /var/lib/radiator/40_clients-tacacsplus.radconf
...
* defined in 50_policies-tacacsplus.radconf
...
* contains some example rules, don't use in production as-is
...
* configuration includes debug clauses to visualize the AAA flow, feel free to remove
